<template>
    <div class="userchat">
        ...
        <van-cell-group  class="message-list">
            ...
            <van-cell center v-for="item,index in messageList" :key="index" :border="false" >
                <div slot="title" class="msgbox">
                    {{item}}
                </div>
                <van-image class="user-photo"
                :src="user.photo" 
                fit="cover"  
                round
                />
        ...
        <van-cell-group center class="send-message">
            <van-field :border="false" type="text" placeholder="请输入内容" v-model="message" />
            <van-button @click="sendMsg" size="small" class="send-btn" type="primary">发送</van-button>
        </van-cell-group>
    </div>
</template>
