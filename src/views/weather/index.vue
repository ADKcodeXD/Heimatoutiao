<template>
    ...
    <div class="wrapper">
        ...
        <div class="weather-top-cotainer">
            <div>
                <div class="main-weather">
                    <div class="main-left">
                        <span class="main-tempture">{{realTime.wtTemp}}°</span>
                        <span class="main-status">{{realTime.wtNm}}</span>
                        <van-image :src="`./icon/d/${realTime.wtIcon}.png`" fit="contain" />
                    </div>
                ...
                <div class="sub-item">
                    <div>当前{{realTime.wtWindNm+" "+wtWindId[realTime.wtWindId]}}</div>
                    <div>{{today.wtTemp2}}°~{{today.wtTemp1}}°</div>
                </div>
            </div>
            <div class="bottom-item">
                <div class="today-wind">今日风向:{{today.wtWindNm1+" " +wtWindId[today.wtWinpId1]}}</div>
        ...
        <div class="rain-and-api">
            <div class="rain">
                降雨概率:{{realTime.wtRainfall}}
            </div>
            <div class="rain">
                空气质量指数:{{realTime.wtAqi}}
            </div>
        </div>
        <!-- 分割 -->
        <div class="title2">
        ...
        <van-cell-group inset>
            <van-cell :border="false" v-for="lifeTip,index in today.lifeIndex"
            :key="index"
            :title="lifeTip.liNm" 
    ...
    export default {
        ...
        data() {
            return {
                ...
                futureDay: [],
                today: {},
                wtWindId: ["小于3级", "3-4级", "4-5级", "5-6级", "6-7级", "7-8级", "8-9级", "9-10级", "10-11级", "11-12级"],
                city: '',
                cities:[]
            }
        },
